...
import { AnalyzeValidationError, VideoAnalyzeServiceImpl } from './video-analyze-service'
...
describe('VideoAnalyzeService', () => {
  ...
  it('rejects oversized file', async () => {
    ...
    await expect(service.analyzeVideo({ file: bigFile, tone: 'friendly' })).rejects.toBeInstanceOf(
